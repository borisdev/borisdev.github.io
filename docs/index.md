...
- **PhD thesis** — What makes an inequality metric capture nuanced gaps among social groups in the same city? Gini and variance silently weight every pair of places the same. I lifted that hidden assumption into an explicit spatial weights matrix — a graph of weighted edges over places — so a Rawlsian concern (unjust institutions) and a Senian one (deprivation relative to your neighbors) imply *different* metrics, and can score the same change in opposite directions. [Essay](spatial-view-is-a-graph.md) · [Full dissertation (PDF)](https://escholarship.org/content/qt8br7d5df/qt8br7d5df.pdf)
